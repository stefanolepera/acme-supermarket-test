import { getPricesAfterDiscount, getFullPriceItems, apply2x1Discount, applyBulkDiscount } from '../discountRules';
...
describe('discountRules tests', () => {
    describe('getPricesAfterDiscount tests', () => {
        it('should return 0 if the list provided is empty', () => {
            const list = [];
            const prices = getPricesAfterDiscount(list, pricingRules);
        ...
        it('should return 40.27 if the list provided is CF1 CF1 FR1 FR1 SR1 SR1 SR1 BN1 BN1', () => {
            ...
            const pricesMock = getPricesAfterDiscount(listMock, pricingRulesMock);
            expect(pricesMock).toEqual(39.07);
        });
    });

    describe('getFullPriceItems tests', () => {
        it('should return 0 if the list provided is FR1 SR1', () => {
            const list = [products['FR1'], products['SR1']];
            const fullPriceItems = getFullPriceItems(list);
    ...
    describe('apply2x1Discount tests', () => {
        it('should return 3.11 if the list provided is FR1 FR1', () => {
            ...
            const discountedPrices = apply2x1Discount(list);
    ...
    describe('apply1FreeDiscount tests', () => {
